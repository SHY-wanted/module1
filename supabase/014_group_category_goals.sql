-- supabase/014_group_category_goals.sql
...
-- 2026-09-22 번호 수정: 원래 013이었는데 recurring_expenses.sql이 013으로 밀리면서 같이 밀었다.
-- 이미 supabase/013_recurring_expenses.sql을 실행해 둔 프로젝트의 SQL Editor에 이 파일만 추가로 실행할 것.
