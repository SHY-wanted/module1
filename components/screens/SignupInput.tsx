  ...
  return (
    <div style={{ height: "100%", width: "100%", boxSizing: "border-box", background: "#F6F5FC", display: "flex", flexDirection: "column", overflowY: "auto" }}>
      ...
      <div style={{ flex: 1, padding: "24px 24px 32px", display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            ...
            <input
              ...
              style={{ width: "100%", boxSizing: "border-box", height: 48, borderRadius: 14, border: "2px solid #E8E4F4", background: "#fff", padding: "0 16px", fontSize: 14, fontWeight: 600, color: "#2D2A3E" }}
            />
          </div>
          <div>
        ...
        {/* 예외: [?] 07-screens.md "1/1b 회원가입 — 이메일 형식 오류·비밀번호 8자 미만 검증 실패 화면이 디자인에 없다".
            임시로 유효성 검증 없이 항상 성공 처리한다. */}
        <div
          onClick={() => nav.goAuthScreen("signupSuccess")}
