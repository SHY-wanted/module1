    ...
    <div style={{ height: "100%", width: "100%", boxSizing: "border-box", background: "var(--shoot-bg)", display: "flex", flexDirection: "column" }}>
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 20px 20px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: "var(--shoot-text)" }}>내 그룹</div>
        </div>
          ...
          {myGroups.map((g) => {
            ...
            return (
              <div
                ...
                style={{ background: "var(--shoot-surface)", borderRadius: 18, padding: 14, display: "flex", alignItems: "center", gap: 12, border: "2px solid var(--shoot-border)", boxShadow: "0 2px 10px rgba(45,42,62,0.05)", cursor: "pointer" }}
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4 }}>
                    ...
                    <span style={{ fontSize: 12, color: "var(--shoot-text-muted)", fontWeight: 600 }}>멤버 {memberCount}명</span>
                  </div>
                </div>
                <ChevronRightIcon size={16} color="var(--shoot-text-muted)" />
              </div>
            );
          })}
        </div>
        <div
          ...
          style={{ marginTop: 16, border: "2px dashed rgba(106,94,207,0.4)", borderRadius: 18, padding: 14, fontSize: 13, fontWeight: 800, color: "var(--shoot-text)", background: "var(--shoot-surface-alt)", textAlign: "center", cursor: "pointer" }}
        >
          초대 코드로 참여하기
        </div>
        {myGroups.length === 0 && (
          <div style={{ marginTop: 24, textAlign: "center", color: "var(--shoot-text-muted)", fontSize: 13, fontWeight: 600, display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
